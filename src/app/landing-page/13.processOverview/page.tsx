...
export default function PROCESSOVER() {
  return (
    // <!-- Process Overview -->
    <section className="bg-white bg-[url('/landingPageAssets/process-bg.png')] bg-cover bg-center min-h-[650px] lg:min-h-[690px] mx-auto backdrop-blur-3xl">
      <div className="bg-white/80 w-full min-h-[650px] lg:min-h-[690px]">
        ...
        {/* <!-- 4 boxes --> */}
        <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:mt-4 px-5 pb-16 items-center justify-between">
          {/* <!-- Box-1 --> */}
          <div className="z-[100] bg-white border relative p-10 rounded-[20px] mt-7">
