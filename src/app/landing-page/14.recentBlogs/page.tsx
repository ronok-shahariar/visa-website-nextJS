      ...
      <section className="min-h-[1040px] mx-auto px-6">
        ...
        <div className="relative mx-auto">
          ...
          <div className="flex flex-row gap-2 pt-[60px] lg:pt-[116px]">
            ...
            />
            <h2
              className="font-roboto font-bold text-[15px] text-greenBody items-center justify-center pt-1"
            >
              RECENT BLOGS
            </h2>
          </div>
          ...
          <div className="lg:flex pt-2">
            <h2
              className="font-roboto font-bold text-greenBody text-[30px] sm:text-[35px] lg:text-[52px] leading-tight"
            >
            ...
            <div
              className="flex w-[80%] h-[20%] lg:justify-end pt-5 lg:pt-24 gap-4"
            >
              <button
                className="flex items-center justify-center w-16 h-16 rounded-full bg-gray-200 border border-gray-200 hover:bg-button transition-all duration-200 group"
              >
                <i
          ...
          <div
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 lg:pt-6"
          >
            {/* <!-- card 1 --> */}
            <div className="relative w-full">
              ...
              {/* <!-- Date and content --> */}
              <div
                className="flex flex-col space-y-5 border border-gray-200 rounded-bl-[20px] rounded-br-[20px]"
              >
                {/* <!-- date and admin --> */}
                <div
                  className="flex flex-row items-stretch justify-between pt-6 px-7"
                >
                  {/* <!-- Date --> */}
                  <button
                    className="flex flex-row gap-x-1 font-roboto text-gray-400 text-[18px]"
                  >
                ...
                <div className="px-7 space-y-2">
                  ...
                  <a href="#">
                    <button
                      className="flex items-center justify-center pt-8 pb-10 lg:flex flex-row w-fit text-greenBody font-roboto font-bold hover:text-getAnAppointment transition-all duration-200 group"
                    >
                      <span>Read More</span>
                      <i
                        data-feather="arrow-right"
            ...
            <div className="hidden md:flex md:flex-col relative w-full h-full">
              ...
              >
                ...
                <div className="px-7 space-y-2 flex-grow">
                  ...
                  <p className="font-roboto text-gray-500">
                    Nancy boy Charles down the pub get <br />stuffed mate easy
                    peasy brown bread...
                  </p>
                  <a href="#">
                    <button
            ...
            <div className="hidden lg:flex lg:flex-col relative w-full">
              ...
              >
                ...
                <div className="px-7 space-y-2">
                  ...
                  <a href="#">
                    <button
                      className="items-center justify-center pt-8 pb-10 hidden lg:flex flex-row w-fit text-greenBody font-roboto font-bold hover:text-getAnAppointment transition-all duration-200 group"
                    >
                      <span>Read More</span>
                      <i
                        data-feather="arrow-right"
